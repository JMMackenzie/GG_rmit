...
# Save the PDF
ggsave(plot,file="mbarplot-dodge.pdf",width=9,height=7, device=cairo_pdf)
embedFonts("mbarplot-dodge.pdf",options='-c ".setpdfwrite <</NeverEmbed [ ]>> setdistillerparams" -dSubsetFonts=true -dCompressFonts=true -dCompatibilityLevel=1.4')
