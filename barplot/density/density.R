...
# 3. Create the density plot. Alpha is how see-through the filling is
plot <- plot + geom_density(alpha=0.4)
...
# Save the PDF
ggsave(plot,file="mdensity.pdf",width=9,height=7, device=cairo_pdf)
embedFonts("mdensity.pdf",options='-c ".setpdfwrite <</NeverEmbed [ ]>> setdistillerparams" -dSubsetFonts=true -dCompressFonts=true -dCompatibilityLevel=1.4')
